...
package com.sofodev.armorplus.compat.projecte;
...
//        addConversion(bow, of(materialA, 11, new ItemStack(materialB), 7));
//    }
//
...
//        addConversion(new ItemStack(ModBlocks.blockCompressedObsidian), of(OBSIDIAN, 9));
//        addConversion(APBlocks.highTechBench, of(new ItemStack(infusedLavaCrystal), 3, new ItemStack(REDSTONE_BLOCK), 5, new ItemStack(ModBlocks.benches[0]), 1));
//        addConversion(APBlocks.ultiTechBench, of(
//            infusedLavaCrystal, 2, theUltimateMaterial, 6, new ItemStack(ModBlocks.benches[0]), 1, new ItemStack(ModBlocks.benches[1]), 1, ModBlocks.blockCompressedObsidian, 8
//        ));
...
//            //
//            addConversion(APItems.chickenHelmet, of(new ItemStack(FEATHER), 3, new ItemStack(EGG), 2));
//            addConversion(APItems.chickenChestplate, of(new ItemStack(FEATHER), 5, new ItemStack(EGG), 3));
//            addConversion(APItems.chickenLeggings, of(new ItemStack(FEATHER), 5, new ItemStack(EGG), 2));
//            addConversion(APItems.chickenBoots, of(new ItemStack(FEATHER), 2, new ItemStack(EGG), 2));
//            //
...
//        addConversion(sword, of(new ItemStack(material), 4, new ItemStack(STICK), 1));
//        addConversion(battleAxe, of(new ItemStack(material), 8, new ItemStack(STICK), 4));
//        addConversion(bow, of(new ItemStack(material), 7, new ItemStack(STRING), 5));
//    }
//
//    private static void createHighTechArmorEMC(Object materialA, Object materialB, Item head, Item chest, Item legs, Item feet) {
//        addConversion(head,
//            of(new ItemStack(materialA), 4, new ItemStack(materialB), 5)
//        );
//        addConversion(chest,
//            of(new ItemStack(materialA), 13, new ItemStack(materialB), 7)
//        );
//        addConversion(legs,
//            of(new ItemStack(materialA), 7, new ItemStack(materialB), 9)
//        );
//        addConversion(feet,
//            of(new ItemStack(materialA), 4, new ItemStack(materialB), 2)
//        );
//    }
//
//    private static void createOriginWeaponsEMC(Object material, Item sword, Item battleAxe, Item bow) {
//        addConversion(sword, of(new ItemStack(material), 2, new ItemStack(STICK), 1));
//        addConversion(battleAxe, of(new ItemStack(material), 4, new ItemStack(STICK), 2));
//        addConversion(bow, of(new ItemStack(material), 3, new ItemStack(STRING), 3));
//    }
//
//    private static void createWorkbenchArmorEMC(Object material, Item head, Item chest, Item legs, Item feet) {
//        createArmorEMC(new ItemStack(material), head, 5, chest, 8, legs, 7, feet, 4);
//    }
//
...
//            ItemStackUtils.new ItemStack(ModItems.theUltimateParts, 0), 1, ItemStackUtils.new ItemStack(ModItems.theUltimateParts, 1), 1, ItemStackUtils.new ItemStack(ModItems.theUltimateParts, 2), 1
//        ));
//        //
...
//            ItemStackUtils.new ItemStack(ModItems.theUltimateParts, 3), 1, ItemStackUtils.new ItemStack(ModItems.theUltimateParts, 4), 1, ItemStackUtils.new ItemStack(ModItems.theUltimateParts, 5), 1
//        ));
//        //
...
//            ItemStackUtils.new ItemStack(ModItems.theUltimateParts, 6), 1, ItemStackUtils.new ItemStack(ModItems.theUltimateParts, 7), 1, ItemStackUtils.new ItemStack(ModItems.theUltimateParts, 8), 1
//        ));
//        //
...
//            ItemStackUtils.new ItemStack(ModItems.theUltimateParts, 9), 1, ItemStackUtils.new ItemStack(ModItems.theUltimateParts, 10), 1, ItemStackUtils.new ItemStack(ModItems.theUltimateParts, 11), 1
//        ));
//    }
//
//    private static void registerUltimatePartsEMC(int right, int middle, int left, Item itemRight, Item itemMid, Item itemLeft) {
//        addConversion(ItemStackUtils.new ItemStack(ModItems.theUltimateParts, right), new ImmutableMap.Builder<Object, Integer>().put(APItems.theUltimateMaterial, 28).put(APItems.infusedLavaCrystal, 12)
//            .put(APItems.guardianScale, 2).put(SPONGE, 2).put(PRISMARINE_SHARD, 2).put(PRISMARINE_CRYSTALS, 2).put(itemRight, 1).build()
//        );
//        addConversion(ItemStackUtils.new ItemStack(ModItems.theUltimateParts, middle), new ImmutableMap.Builder<Object, Integer>().put(APItems.theUltimateMaterial, 28).put(APItems.infusedLavaCrystal, 12)
//            .put(APItems.enderDragonScale, 2).put(END_CRYSTAL, 2).put(ENDER_EYE, 2).put(ENDER_PEARL, 2).put(itemMid, 1).build()
//        );
//        addConversion(ItemStackUtils.new ItemStack(ModItems.theUltimateParts, left), new ImmutableMap.Builder<Object, Integer>().put(APItems.theUltimateMaterial, 28).put(APItems.infusedLavaCrystal, 12)
...
//            of(guardianScale, 8, new ItemStack(SEA_LANTERN), 3, new ItemStack(PRISMARINE_CRYSTALS), 3, new ItemStack(PRISMARINE), 2)
//        );
//        addConversion(APItems.guardianChestplate,
//            of(guardianScale, 20, new ItemStack(SEA_LANTERN), 4, new ItemStack(PRISMARINE_CRYSTALS), 4, new ItemStack(PRISMARINE), 6)
//        );
//        addConversion(APItems.guardianLeggings,
//            of(guardianScale, 15, new ItemStack(SEA_LANTERN), 1, new ItemStack(PRISMARINE_CRYSTALS), 4, new ItemStack(PRISMARINE), 4)
//        );
//        addConversion(APItems.guardianBoots,
//            of(guardianScale, 6, new ItemStack(SPONGE), 2)
//        );
//        addConversion(APItems.guardianSword, of(guardianScale, 7, new ItemStack(PRISMARINE_SHARD), 6));
//        addConversion(APItems.guardianBattleAxe, of(guardianScale, 12, new ItemStack(PRISMARINE_SHARD), 6));
//        addConversion(APItems.guardianBow, of(guardianScale, 11, new ItemStack(PRISMARINE_SHARD), 7));
//    }
//
//    private static void registerSuperStarEMC(ItemStack witherBone) {
//        addConversion(APItems.superStarHelmet,
//            of(witherBone, 8, new ItemStack(NETHER_STAR), 5, new ItemStack(SOUL_SAND), 2)
//        );
//        addConversion(APItems.superStarChestplate,
//            of(witherBone, 19, new ItemStack(NETHER_STAR), 10, new ItemStack(SOUL_SAND), 4, new ItemStack(Items.SKULL, 1), 1)
//        );
//        addConversion(APItems.superStarLeggings,
//            of(witherBone, 6, new ItemStack(NETHER_STAR), 7, new ItemStack(SOUL_SAND), 4)
//        );
//        addConversion(APItems.superStarBoots,
//            of(witherBone, 4, new ItemStack(NETHER_STAR), 2, new ItemStack(SOUL_SAND), 2)
//        );
//        addConversion(APItems.superStarSword, of(witherBone, 6, new ItemStack(NETHER_STAR), 6, new ItemStack(Items.SKULL, 1), 1));
//        addConversion(APItems.superStarBattleAxe, of(witherBone, 12, new ItemStack(NETHER_STAR), 5, new ItemStack(Items.SKULL, 1), 1));
//        addConversion(APItems.superStarBow, of(witherBone, 6, new ItemStack(NETHER_STAR), 5, new ItemStack(STRING), 7));
//    }
//
//    private static void registerEnderDragonEMC(ItemStack enderDragonScale) {
//        addConversion(APItems.enderDragonHelmet,
//            of(enderDragonScale, 11, new ItemStack(ENDER_EYE), 2, new ItemStack(END_CRYSTAL), 2)
//        );
//        addConversion(APItems.enderDragonChestplate,
//            of(enderDragonScale, 18, new ItemStack(ENDER_EYE), 6, new ItemStack(END_CRYSTAL), 6, new ItemStack(END_STONE), 4)
//        );
//        addConversion(APItems.enderDragonLeggings,
//            of(enderDragonScale, 17, new ItemStack(ENDER_EYE), 3, new ItemStack(END_CRYSTAL), 6)
//        );
//        addConversion(APItems.enderDragonBoots,
//            of(enderDragonScale, 4, new ItemStack(ENDER_EYE), 2, new ItemStack(END_CRYSTAL), 2)
//        );
//        addConversion(APItems.enderDragonSword, of(enderDragonScale, 6, new ItemStack(DRAGON_BREATH), 6));
//        addConversion(APItems.enderDragonBattleAxe, of(enderDragonScale, 12, new ItemStack(DRAGON_BREATH), 6));
//        addConversion(APItems.enderDragonBow, of(enderDragonScale, 6, new ItemStack(DRAGON_BREATH), 5, new ItemStack(STRING), 7));
//    }
//}
//