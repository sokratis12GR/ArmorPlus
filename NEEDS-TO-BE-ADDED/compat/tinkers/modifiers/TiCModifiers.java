...
//
//    private static final ItemStack infusedLavaCrystal = new ItemStack(ModItems.itemInfusedLavaCrystal);
...
//        theUltimateMaterial.addRecipeMatch(new RecipeMatch.ItemCombination(3, new ItemStack(ModItems.theUltimateMaterial)));
