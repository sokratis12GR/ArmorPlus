...
public class APItems {
    ...
    public static Item coalHelmet = getItem("");
    public static Item coalChestplate = getItem("");
    public static Item coalLeggings = getItem("");
    public static Item coalBoots = getItem("");
    public static Item lapisHelmet = getItem("");
    public static Item lapisChestplate = getItem("");
    public static Item lapisLeggings = getItem("");
    public static Item lapisBoots = getItem("");
    public static Item redstoneHelmet = getItem("");
    public static Item redstoneChestplate = getItem("");
    public static Item redstoneLeggings = getItem("");
    public static Item redstoneBoots = getItem("");
    public static Item emeraldHelmet = getItem("");
    public static Item emeraldChestplate = getItem("");
    public static Item emeraldLeggings = getItem("");
    public static Item emeraldBoots = getItem("");
    public static Item obsidianHelmet = getItem("");
    public static Item obsidianChestplate = getItem("");
    public static Item obsidianLeggings = getItem("");
    public static Item obsidianBoots = getItem("");
    public static Item lavaHelmet = getItem("");
    public static Item lavaChestplate = getItem("");
    public static Item lavaLeggings = getItem("");
    public static Item lavaBoots = getItem("");
    public static Item chickenHelmet = getItem("");
    public static Item chickenChestplate = getItem("");
    public static Item chickenLeggings = getItem("");
    public static Item chickenBoots = getItem("");
    public static Item slimeHelmet = getItem("");
    public static Item slimeChestplate = getItem("");
    public static Item slimeLeggings = getItem("");
    public static Item slimeBoots = getItem("");
    public static Item guardianHelmet = getItem("");
    public static Item guardianChestplate = getItem("");
    public static Item guardianLeggings = getItem("");
    public static Item guardianBoots = getItem("");
    public static Item superStarHelmet = getItem("");
    public static Item superStarChestplate = getItem("");
    public static Item superStarLeggings = getItem("");
    public static Item superStarBoots = getItem("");
    public static Item enderDragonHelmet = getItem("");
    public static Item enderDragonChestplate = getItem("");
    public static Item enderDragonLeggings = getItem("");
    public static Item enderDragonBoots = getItem("");
    public static Item theUltimateHelmet = getItem("");
    public static Item theUltimateChestplate = getItem("");
    public static Item theUltimateLeggings = getItem("");
    public static Item theUltimateBoots = getItem("");
    public static Item cobaltHelmet = getItem("");
    public static Item cobaltChestplate = getItem("");
    public static Item cobaltLeggings = getItem("");
    public static Item cobaltBoots = getItem("");
    public static Item arditeHelmet = getItem("");
    public static Item arditeChestplate = getItem("");
    public static Item arditeLeggings = getItem("");
    public static Item arditeBoots = getItem("");
    public static Item manyullynHelmet = getItem("");
    public static Item manyullynChestplate = getItem("");
    public static Item manyullynLeggings = getItem("");
    public static Item manyullynBoots = getItem("");
    public static Item pigIronHelmet = getItem("");
    public static Item pigIronChestplate = getItem("");
    public static Item pigIronLeggings = getItem("");
    public static Item pigIronBoots = getItem("");
    public static Item knightSlimeHelmet = getItem("");
    public static Item knightSlimeChestplate = getItem("");
    public static Item knightSlimeLeggings = getItem("");
    public static Item knightSlimeBoots = getItem("");
    public static Item coalSword = getItem("");
    public static Item coalBattleAxe = getItem("");
    public static Item coalBow = getItem("");
    public static Item lapisSword = getItem("");
    public static Item lapisBattleAxe = getItem("");
    public static Item lapisBow = getItem("");
    public static Item redstoneSword = getItem("");
    public static Item redstoneBattleAxe = getItem("");
    public static Item redstoneBow = getItem("");
    public static Item emeraldSword = getItem("");
    public static Item emeraldBattleAxe = getItem("");
    public static Item emeraldBow = getItem("");
    public static Item obsidianSword = getItem("");
    public static Item obsidianBattleAxe = getItem("");
    public static Item obsidianBow = getItem("");
    public static Item lavaSword = getItem("");
    public static Item lavaBattleAxe = getItem("");
    public static Item lavaBow = getItem("");
    public static Item guardianSword = getItem("");
    public static Item guardianBattleAxe = getItem("");
    public static Item guardianBow = getItem("");
    public static Item superStarSword = getItem("");
    public static Item superStarBattleAxe = getItem("");
    public static Item superStarBow = getItem("");
    public static Item enderDragonSword = getItem("");
    public static Item enderDragonBattleAxe = getItem("");
    public static Item enderDragonBow = getItem("");
    ...
    public static void registerItemNames() {
      ...
      //  }
        ...
        // infusedLavaCrystal = new ItemStack(ModItems.itemInfusedLavaCrystal);
        // chainmail = new ItemStack(ModItems.materials, 0);
        // guardianScale = new ItemStack(guardianScale);
        // witherBone = new ItemStack(witherBone);
        // enderDragonScale = new ItemStack(enderDragonScale);
        // theUltimateMaterial = new ItemStack(ModItems.theUltimateMaterial);
    }
