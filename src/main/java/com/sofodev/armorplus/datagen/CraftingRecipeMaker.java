...
public class CraftingRecipeMaker extends RecipeProvider {
    ...
    /**
     * @see CraftingRecipeMaker#build(Consumer, RecipeCategory, Result, GridInput, ItemLike, Ingredient...)
     * @since 16.2.0
     */
    ...
    /**
     * @see CraftingRecipeMaker#build(Consumer, RecipeCategory, Result, ItemLike, Ingredient...)
     */
