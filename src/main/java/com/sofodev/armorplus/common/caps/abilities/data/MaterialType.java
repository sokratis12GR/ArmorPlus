...
import static com.sofodev.armorplus.common.registry.items.armors.base.ItemPlaceholderArmor.*;
...
public class MaterialType {
    ...
    public static final MaterialType INFUSED_LAVA = new MaterialType("infused_lava", 3, LAVA_ARMOR);
    ...
    public static final MaterialType ULTIMATE = new MaterialType("ultimate", 4, ULTIMATE_ARMOR);
