...
public class StructureGenNBT implements IWorldGenerator {
    ...
    public void generateTower(WorldServer world, Random random, BlockPos pos) {
        if (ModConfig.WorldGenConfig.tower.enable && ((random.nextInt(ModConfig.WorldGenConfig.tower.chanceNeededForSpawning) < ModConfig.WorldGenConfig.tower.spawnChance) || random.nextInt(100) < 10)) {
