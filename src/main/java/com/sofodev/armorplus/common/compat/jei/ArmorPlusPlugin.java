...
//                // ItemStackUtils.new ItemStack(ModItems.jonBamsItem, 1),
...
//
//        registry.addRecipeCatalyst(new ItemStack(ModBlocks.lavaInfuser), JEI_CATEGORY_LAVA_INFUSER);
//
//        IntStream.range(0, JEI_CATEGORIES.length).forEach(i -> registry.addRecipeCatalyst(new ItemStack(ModBlocks.benches[i]), JEI_CATEGORIES[i]));
//
...
//                blacklist.addIngredientToBlacklist(new ItemStack(stack));
//            }
//        });
//    }
//
...
//            createDesc(new ItemStack(ModBlocks.lavaInfuser), "armorplus.jei.lava_infuser.desc")
//        );
//    }
//
