...
public final class Utils {
    ...
    public static NonNullList<ItemStack> getItemStacks(Item... items) {
        ...
        if (items != null) Arrays.stream(items).map(ItemStack::new).forEachOrdered(list::add);
        return list;
    }
    ...
    public static IItemProvider getItem(ResourceLocation location) {
    ...
    public static IItemProvider getItem(String name) {
        Item value = ForgeRegistries.ITEMS.getValue(setRL(name));
        if (value != null) {
            return value;
        } else return Items.AIR;
    }

    public static IItemProvider getBlock(ResourceLocation location) {
    ...
    public static IItemProvider getBlock(String name) {
        Block value = ForgeRegistries.BLOCKS.getValue(setRL(name));
        if (value != null) {
            return value;
        } else return Items.AIR;
    }
