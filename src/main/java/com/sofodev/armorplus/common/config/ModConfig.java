...
public class ModConfig {
    ...
    public static class RegistryConfig {
        ...
        public static class Blocks {
            ...
            public HarvestProps stone_bricks = new HarvestProps(PICKAXE);
            public HarvestProps ore_lava_crystal = new HarvestProps(PICKAXE, 3);
            public HarvestProps lava_cactus = new HarvestProps(PICKAXE);
            public HarvestProps lava_infuser = new HarvestProps(PICKAXE, 1);
            public HarvestProps lava_material = new HarvestProps(PICKAXE, 2);
            public HarvestProps lava_nether_brick = new HarvestProps(PICKAXE, 1);
            public HarvestProps block_compressed_obsidian = new HarvestProps(PICKAXE, 3);
            public HarvestProps block_trophy = new HarvestProps(PICKAXE, 1);
            public HarvestProps block_metal = new HarvestProps(PICKAXE, 1);
        ...
        public static OriginMaterial lava = new OriginMaterial(
            ...
            new CombinedWeapon("gold", "armorplusempty", new WeaponSet(4.5, 0.5, 1750)), true, 8
        );
