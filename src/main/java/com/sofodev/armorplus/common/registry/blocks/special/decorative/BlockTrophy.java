...
import static com.sofodev.armorplus.common.registry.blocks.special.decorative.Trophy.ANY;
...
public class BlockTrophy extends BlockBase implements IModdedBlock {
    ...
    public BlockTrophy(Trophy type) {
        ...
        this.setCreativeTab(ArmorPlus.tabArmorPlusTrophies);
    }
    ...
    public void initModel() {
        this.initModel(setRL("trophy"), "", "", 0, "normal");
    }
}
