...
package com.sofodev.armorplus.common.registry.entity.dungeon.guardianoverlord;

import com.sofodev.armorplus.ArmorPlus;
import com.sofodev.armorplus.common.registry.entity.dungeon.base.BossInfoServerDungeon;
import com.sofodev.armorplus.common.registry.entity.dungeon.base.BossInfoServerDungeon.BossInfoDungeonType;
...
public class EntityGuardianOverlord extends EntityGuardian implements IRangedAttackMob {
    ...
    public EntityGuardianOverlord(World worldIn) {
        super(ArmorPlus.RegistryEvents.ENTITY_GUARDIAN_OVERLORD, worldIn);
...
//        Old stuffs -I wonder if I will ever need to change it back
    ...
    protected void registerAttributes() {
        ...
        this.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(1200D);
    }
