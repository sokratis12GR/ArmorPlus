...
import com.sofodev.armorplus.common.registry.entity.dungeon.base.BossInfoServerDungeon;
import com.sofodev.armorplus.common.registry.entity.dungeon.base.EntityAIRangedDungeonAttack;
import com.sofodev.armorplus.common.registry.entity.dungeon.base.EntityAIRangedDungeonAttack.EntityAIType;
...
import static com.sofodev.armorplus.ArmorPlus.RegistryEvents.ENTITY_SKELETAL_KING;
import static com.sofodev.armorplus.common.registry.entity.dungeon.base.BossInfoServerDungeon.BossInfoDungeonType;
 ...
 **/
public class EntitySkeletalKing extends AbstractSkeleton implements IRangedAttackMob {
    ...
    public EntitySkeletalKing(World worldIn) {
        super(ENTITY_SKELETAL_KING, worldIn);
    ...
    protected void registerAttributes() {
        ...
        this.getAttribute(MAX_HEALTH).setBaseValue(1200.0D);
        this.getAttribute(MOVEMENT_SPEED).setBaseValue(0.6000000238418579D);
        this.getAttribute(ARMOR).setBaseValue(4.0F);
    }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata, @Nullable NBTTagCompound nbt) {
        ...
        return super.onInitialSpawn(difficulty, livingdata, nbt);
    }
