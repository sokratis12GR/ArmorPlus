...
public class ModOreDicts {
    ...
    public static void registerOreDictEntries() {
        ...
        //Benches
        registerOre("apWorkbench", APBlocks.workbench);
        registerOre("workbenchTier1", APBlocks.workbench);
        registerOre("workbenchTierOne", APBlocks.workbench);
        registerOre("apHighTechBench", APBlocks.highTechBench);
        registerOre("workbenchTier2", APBlocks.highTechBench);
        registerOre("workbenchTierTwo", APBlocks.highTechBench);
        registerOre("apUltiTechBench", APBlocks.ultiTechBench);
        registerOre("workbenchTier3", APBlocks.ultiTechBench);
        registerOre("workbenchTierThree", APBlocks.ultiTechBench);
        registerOre("apChampionBench", APBlocks.championBench);
        registerOre("workbenchTier4", APBlocks.championBench);
        registerOre("workbenchTierFour", APBlocks.championBench);
