...
import com.sofodev.armorplus.api.properties.ArmorSet;
import net.minecraft.item.Item;
import net.minecraft.item.ItemStack;

import static com.sofodev.armorplus.common.registry.APItems.*;
import static com.sofodev.armorplus.common.util.Utils.emptyArmor;
...
public class Skeleton {
    ...
    //400-200
    public static final Skeleton PALADIN_1 = new Skeleton(PALADIN, PALADIN_HEALTH, superStarSword, new ItemStack(SHIELD), new ArmorSet(DIAMOND_HELMET, DIAMOND_CHESTPLATE, DIAMOND_LEGGINGS, DIAMOND_BOOTS));
    public static final Skeleton PALADIN_2 = new Skeleton(PALADIN, PALADIN_HEALTH + 5, superStarBattleAxe, new ItemStack(SHIELD), new ArmorSet(superStarHelmet, superStarChestplate, superStarLeggings, superStarBoots));
    ...
    public Skeleton(String name, double health, Item weapon, ItemStack offHand, ArmorSet set) {
        this(name, health, new ItemStack(weapon), offHand, set.getSet());
    }
