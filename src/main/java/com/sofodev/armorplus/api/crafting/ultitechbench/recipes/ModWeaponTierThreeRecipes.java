            ...
            case EASY: {
                if (recipes.enableSwordsRecipes) {
                    if (global_registry.enableGuardianWeapons[0]) {
                        UTBRecipesHelper.registerSwordRecipe(manager, "scaleGuardian", guardianSword);
                    }
                    if (global_registry.enableSuperStarWeapons[0]) {
                        UTBRecipesHelper.registerSwordRecipe(manager, "witherBone", superStarSword);
                    }
                    if (global_registry.enableEnderDragonWeapons[0]) {
                        UTBRecipesHelper.registerSwordRecipe(manager, "scaleEnderDragon", enderDragonSword);
                    }
                }
                if (recipes.enableBattleAxesRecipes) {
                    if (global_registry.enableGuardianWeapons[1]) {
                        UTBRecipesHelper.registerBattleAxeRecipe(manager, "scaleGuardian", guardianBattleAxe);
                    }
                    if (global_registry.enableSuperStarWeapons[1]) {
                        UTBRecipesHelper.registerBattleAxeRecipe(manager, "witherBone", superStarBattleAxe);
                    }
                    if (global_registry.enableEnderDragonWeapons[1]) {
                        UTBRecipesHelper.registerBattleAxeRecipe(manager, "scaleEnderDragon", enderDragonBattleAxe);
                    }
                }
                if (recipes.enableBowsRecipes) {
                    if (global_registry.enableGuardianWeapons[2]) {
                        UTBRecipesHelper.registerBowRecipes(manager, "scaleGuardian", "gemPrismarine", guardianBow);
                    }
                    if (global_registry.enableSuperStarWeapons[2]) {
                        UTBRecipesHelper.registerBowRecipes(manager, "witherBone", "string", superStarBow);
                    }
                    if (global_registry.enableEnderDragonWeapons[2]) {
                        UTBRecipesHelper.registerBowRecipes(manager, "scaleEnderDragon", "string", enderDragonBow);
                    }
                }
                break;
            }
