...
//
//public class FrostWolfAlphaEntity extends Animal implements IAnimatable, NeutralMob {
//
//    private static final Parameter<Boolean> DATA_INTERESTED_ID = EntityDataManager.defineId(FrostWolfAlphaEntity.class, DataSerializers.BOOLEAN);
...
//
//    public FrostWolfAlphaEntity(EntityType<? extends FrostWolfAlphaEntity> type, Level worldIn) {
//        super(type, worldIn);
//    }
//
...
//        return Mob.createMobAttributes().add(Attributes.MOVEMENT_SPEED, 0.3F).add(Attributes.MAX_HEALTH, 20.0D).add(Attributes.ATTACK_DAMAGE, 5.0D);
//    }
//
//    @Override
...
//    @Nullable
//    @Override
//    public FrostWolfAlphaEntity getBreedOffspring(ServerLevel world, AgeableEntity ageableEntity) {
