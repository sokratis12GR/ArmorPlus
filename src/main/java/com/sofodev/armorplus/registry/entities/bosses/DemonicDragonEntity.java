...
// **/
//public class DemonicDragonEntity extends Monster implements RangedAttackMob, IAnimatable {
//
...
//
//    public DemonicDragonEntity(EntityType<? extends DemonicDragonEntity> type, Level world) {
//        super(type, world);
...
//            WorldData configuration = server.getWorldData();
...
//        return EntityDimensions.scalable(4, 4).scale(1f, 1f);
//    }
//
//    @Override
...
//            if (trueSource != null && !(trueSource instanceof Player) && trueSource instanceof LivingEntity && ((LivingEntity) trueSource).getMobType() == this.getMobType()) {
//                return false;
//            } else {
