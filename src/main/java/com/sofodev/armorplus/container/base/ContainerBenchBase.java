...
public class ContainerBenchBase extends ContainerBase {
    ...
    protected void addPlayerArmorInventoryTop(InventoryPlayer inventory, int xPos, int yPos) {
        ...
        for (int index = 0; index < 2; index++) {
            ...
            addSlot(new SlotArmor(inventory, fullInventoryIndex + (3 - index), xPos + index * ITEM_BOX, yPos, inventory.player, equipmentSlot));
        }
    }
    ...
    protected void addPlayerArmorInventoryBot(InventoryPlayer inventory, int xPos, int yPos) {
        ...
        for (int index = 0; index < 2; index++) {
            ...
            addSlot(new SlotArmor(inventory, fullInventoryIndex + (3 - (index + secondaryIndex)), xPos + index * ITEM_BOX, yPos, inventory.player, equipmentSlot));
        }
    }
}
