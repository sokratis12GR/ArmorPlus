...
public class WikiCommand {
    ...
    public static int execute(CommandSource sender) {
        ...
        Style wiki = Style.EMPTY.setClickEvent(new ClickEvent(OPEN_URL, link)).setHoverEvent(new HoverEvent(SHOW_TEXT, translate("commands.armorplus.wiki.link_open")));
        sender.sendFeedback(translate(AQUA, "commands.armorplus.wiki.link_details", link).setStyle(wiki), false);
