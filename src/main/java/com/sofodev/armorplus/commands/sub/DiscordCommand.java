...
public class DiscordCommand {
    ...
    public static int execute(CommandSource sender) {
        ...
        Style ap = Style.EMPTY.setClickEvent(new ClickEvent(OPEN_URL, discord)).setHoverEvent(new HoverEvent(SHOW_TEXT, translate("commands.armorplus.discord.hover")));
        sender.sendFeedback(translate(AQUA, "commands.armorplus.discord.line_one", discord).setStyle(ap), true);
