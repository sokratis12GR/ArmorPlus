...
public class BlockLavaInfuser extends BlockContainer implements IModdedBlock {
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos) {
        ...
        if (active) {
            worldIn.setBlockState(pos, getNeededState(ModBlocks.lavaInfuserInfusing, iblockstate), 3);
            worldIn.setBlockState(pos, getNeededState(ModBlocks.lavaInfuserInfusing, iblockstate), 3);
        } else {
            worldIn.setBlockState(pos, getNeededState(ModBlocks.lavaInfuser, iblockstate), 3);
            worldIn.setBlockState(pos, getNeededState(ModBlocks.lavaInfuser, iblockstate), 3);
        }
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ItemStackUtils.getItem(ModBlocks.lavaInfuser);
    }
