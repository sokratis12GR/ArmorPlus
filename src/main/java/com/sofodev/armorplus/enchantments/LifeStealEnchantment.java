...
public class LifeStealEnchantment extends EnchantmentBase {
    ...
    public LifeStealEnchantment() {
        super("life_steal", Rarity.RARE, EnumEnchantmentType.BREAKABLE, new EntityEquipmentSlot[]{EntityEquipmentSlot.MAINHAND},
            1, 3, 10, 15, true, true
        );
    }
    ...
    public void onEntityDamaged(EntityLivingBase user, Entity target, int level) {
        ...
        if (!isCorrectItem(handItem)) {
            ...
            damageDealt = ((ItemTool) handItem).getTier().getAttackDamage();
