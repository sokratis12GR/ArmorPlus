...
public class AbilityDataHandler {
    ...
    public static IAbilityHandler getHandler(ItemStack stack) {
        if (stack.getItem() instanceof ISpecialItem) {
            return (IAbilityHandler) stack.getCapability(CAPABILITY_ABILITIES);
        } else return (IAbilityHandler) LazyOptional.empty();
    }
    ...
    public static class DefaultAbilityData extends ForgeRegistryEntry<DefaultAbilityData> implements IAbilityHandler {
    ...
    public static class Storage implements Capability.IStorage<IAbilityHandler> {
        ...
        @Override
        public INBTBase writeNBT(Capability<IAbilityHandler> capability, IAbilityHandler instance, EnumFacing side) {
        ...
        @Override
        public void readNBT(Capability<IAbilityHandler> capability, IAbilityHandler instance, EnumFacing side, INBTBase nbt) {
