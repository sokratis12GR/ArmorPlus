...
public class PigIronHelmet extends ItemArmor {
    ...
    public PigIronHelmet() {
        ...
        setUnlocalizedName("PigIronHelmet");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:PigIronHelmet", "inventory"));
    }
