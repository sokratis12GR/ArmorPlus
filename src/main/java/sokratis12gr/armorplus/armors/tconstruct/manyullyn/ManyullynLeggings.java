 ...
 */
public class ManyullynLeggings extends ItemArmor {
    ...
    public ManyullynLeggings() {
        ...
        setUnlocalizedName("ManyullynLeggings");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:ManyullynLeggings", "inventory"));
    }
