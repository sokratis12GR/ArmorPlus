...
public class RIHelmet extends ItemArmor {
    ...
    public RIHelmet() {
        ...
        setUnlocalizedName("RIHelmet");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:RIHelmet", "inventory"));
    }
