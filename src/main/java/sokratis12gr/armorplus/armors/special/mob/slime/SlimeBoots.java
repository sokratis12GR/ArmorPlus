...
public class SlimeBoots extends ItemArmor {
    ...
    public SlimeBoots() {
        super(ModItems.SLIME_ARMOR_MATERIAL, armorPreffix, EntityEquipmentSlot.FEET);
        setMaxStackSize(1);
        setRegistryName("slime_boots");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName("SlimeBoots");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:SlimeBoots", "inventory"));
    }
