...
public class SuperStarLeggings extends ItemArmor {
    ...
    public SuperStarLeggings() {
        ...
        setUnlocalizedName("SuperStarLeggings");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:SuperStarLeggings", "inventory"));
    }
