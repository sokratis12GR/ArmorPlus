...
public class ObsidianChestplate extends ItemArmor {
    ...
    public ObsidianChestplate() {
        ...
        setUnlocalizedName("ObsidianChestplate");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:ObsidianChestplate", "inventory"));
    }
