package sokratis12gr.armorplus.armors.origin.lapis;
...
public class LapisChestplate extends ItemArmor {
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:LapisChestplate", "inventory"));
    }
