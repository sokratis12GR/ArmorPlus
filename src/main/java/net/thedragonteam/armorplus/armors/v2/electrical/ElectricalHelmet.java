...
public class ElectricalHelmet extends ItemArmor {
    ...
    public ElectricalHelmet() {
        super(ModItems.ELECTRICAL_ARMOR_MATERIAL, armorPreffix, EntityEquipmentSlot.HEAD);
        setMaxStackSize(1);
        setRegistryName("electrical_helmet");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName("ElectricalHelmet");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:ElectricalHelmet", "inventory"));
    }
