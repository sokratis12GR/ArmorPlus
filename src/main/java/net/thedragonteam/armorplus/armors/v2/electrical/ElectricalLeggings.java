 ...
 * - TheDragonTeam
 */
public class ElectricalLeggings extends ItemArmor {
    ...
    public ElectricalLeggings() {
        ...
        setUnlocalizedName("ElectricalLeggings");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:ElectricalLeggings", "inventory"));
    }
