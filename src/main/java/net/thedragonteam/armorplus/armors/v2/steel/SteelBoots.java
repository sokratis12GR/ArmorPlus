...
public class SteelBoots extends ItemArmor {
    ...
    public SteelBoots() {
        ...
        setUnlocalizedName("SteelBoots");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:SteelBoots", "inventory"));
    }
