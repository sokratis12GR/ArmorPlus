 ...
 * - TheDragonTeam
 */
public class SteelBoots extends BaseTeslaArmor {

    public SteelBoots() {
        super(ModItems.steelArmorNotPowered, 0, EntityEquipmentSlot.FEET, "steel_boots", 0, maxCapacitySteelArmor, inputSteelArmor, outputSteelArmor);
        setMaxDamage(0);
    }
