...
public class LapisBoots extends BaseArmor {
    ...
    public LapisBoots() {
        super(ModItems.lapisArmor, 0, EntityEquipmentSlot.FEET, "lapis_boots", new ItemStack(Items.DYE, 1, 4), Blocks.LAPIS_BLOCK, TextFormatting.DARK_BLUE);
    }
    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
        ...
        if (GameSettings.isKeyDown(keyBindSneak)) if (ARPConfig.enableLapisBBreathing) {
