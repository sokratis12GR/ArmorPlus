...
public class EmeraldBoots extends ItemArmor {
    ...
    public EmeraldBoots() {
        super(ModItems.EMERALD_ARMOR_MATERIAL, armorPreffix, EntityEquipmentSlot.FEET);
        setMaxStackSize(1);
        setRegistryName("emerald_boots");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName("EmeraldBoots");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:EmeraldBoots", "inventory"));
    }
