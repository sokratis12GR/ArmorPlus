...
public class EmeraldChestplate extends ItemArmor {
    ...
    public EmeraldChestplate() {
        super(ModItems.EMERALD_ARMOR_MATERIAL, armorPreffix, EntityEquipmentSlot.CHEST);
        setMaxStackSize(1);
        setRegistryName("emerald_chestplate");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName("EmeraldChestplate");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:EmeraldChestplate", "inventory"));
    }
