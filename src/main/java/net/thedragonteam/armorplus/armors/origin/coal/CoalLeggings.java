 ...
 */
public class CoalLeggings extends ItemArmor {
    ...
    public CoalLeggings() {
        ...
        setUnlocalizedName("CoalLeggings");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:CoalLeggings", "inventory"));
    }
