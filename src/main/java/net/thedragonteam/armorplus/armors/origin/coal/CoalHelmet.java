 ...
 * - TheDragonTeam
 */
public class CoalHelmet extends ItemArmor {

    public static int armorPreffix = 0;

    public CoalHelmet() {
        super(ModItems.coalArmor, armorPreffix, EntityEquipmentSlot.HEAD);
        setMaxStackSize(1);
        setRegistryName("coal_helmet");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName(ArmorPlus.MODID + "." + "coal_helmet");     // Used for localization (en_US.lang)
