...
public class CoalHelmet extends BaseArmor {
    ...
    public CoalHelmet() {
        super(ModItems.coalArmor, 0, EntityEquipmentSlot.HEAD, "coal_helmet", Items.COAL, Blocks.COAL_BLOCK, TextFormatting.GRAY);
    }
    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
        ...
        if (GameSettings.isKeyDown(keyBindSneak)) if (ARPConfig.enableCoalHNightVision) {
