...
public class KnightSlimeLeggings extends BaseArmor {
    ...
    public KnightSlimeLeggings() {
        super(ModItems.knightSlimeArmor, 0, EntityEquipmentSlot.LEGS, "knight_slime_leggings", new ItemStack(Item.getByNameOrId("tconstruct:ingots"), 1, 3), new ItemStack(Item.getByNameOrId("tconstruct:metal"), 1, 3), TextFormatting.DARK_PURPLE);
    }
