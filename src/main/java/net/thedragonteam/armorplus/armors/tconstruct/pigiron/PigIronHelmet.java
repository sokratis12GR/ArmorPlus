...
public class PigIronHelmet extends BaseArmor {
    ...
    public PigIronHelmet() {
        super(ModItems.pigIronArmor, 0, EntityEquipmentSlot.HEAD, "pig_iron_helmet", new ItemStack(Item.getByNameOrId("tconstruct:ingots"), 1, 4), new ItemStack(Item.getByNameOrId("tconstruct:metal"), 1, 4), TextFormatting.LIGHT_PURPLE);
    }
