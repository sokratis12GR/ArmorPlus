 ...
 * - TheDragonTeam
 */
public class PigIronLeggings extends ItemArmor {
    ...
    public PigIronLeggings() {
        ...
        setUnlocalizedName("PigIronLeggings");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:PigIronLeggings", "inventory"));
    }
