...
public class ManyullynHelmet extends BaseArmor {
    ...
    public ManyullynHelmet() {
        super(ModItems.manyullynArmor, 0, EntityEquipmentSlot.HEAD, "manyullyn_helmet", new ItemStack(Item.getByNameOrId("tconstruct:ingots"), 1, 2), new ItemStack(Item.getByNameOrId("tconstruct:metal"), 1, 2), TextFormatting.DARK_PURPLE);
    }
