...
public class CobaltHelmet extends BaseArmor {
    ...
    public CobaltHelmet() {
        super(ModItems.cobaltArmor, 0, EntityEquipmentSlot.HEAD, "cobalt_helmet", new ItemStack(Item.getByNameOrId("tconstruct:ingots"), 1, 0), new ItemStack(Item.getByNameOrId("tconstruct:metal"), 1, 0), TextFormatting.BLUE);
    }
