...
public class ManyullynChestplate extends BaseArmor {
    ...
    public ManyullynChestplate() {
        super(ModItems.manyullynArmor, 0, EntityEquipmentSlot.CHEST, "manyullyn_chestplate", new ItemStack(Item.getByNameOrId("tconstruct:ingots"), 1, 2), new ItemStack(Item.getByNameOrId("tconstruct:metal"), 1, 2), TextFormatting.DARK_PURPLE);
    }
