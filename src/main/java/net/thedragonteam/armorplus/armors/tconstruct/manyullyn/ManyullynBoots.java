...
public class ManyullynBoots extends BaseArmor {
    ...
    public ManyullynBoots() {
        super(ModItems.manyullynArmor, 0, EntityEquipmentSlot.FEET, "manyullyn_boots", new ItemStack(Item.getByNameOrId("tconstruct:ingots"), 1, 2), new ItemStack(Item.getByNameOrId("tconstruct:metal"), 1, 2), TextFormatting.DARK_PURPLE);
    }
