...
public class KnightSlimeBoots extends ItemArmor {
    ...
    public KnightSlimeBoots() {
        super(ModItems.KNIGHT_SLIME_ARMOR_MATERIAL, armorPreffix, EntityEquipmentSlot.FEET);
        setMaxStackSize(1);
        setRegistryName("knight_slime_boots");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName("KnightSlimeBoots");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:KnightSlimeBoots", "inventory"));
    }
