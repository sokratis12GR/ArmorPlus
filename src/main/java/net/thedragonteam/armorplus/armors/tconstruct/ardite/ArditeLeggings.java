...
public class ArditeLeggings extends BaseArmor {
    ...
    public ArditeLeggings() {
        super(ModItems.arditeArmor, 0, EntityEquipmentSlot.LEGS, "ardite_leggings", new ItemStack(Item.getByNameOrId("tconstruct:ingots"), 1, 1), new ItemStack(Item.getByNameOrId("tconstruct:metal"), 1, 1), TextFormatting.DARK_RED);
    }
