...
public class SuperStarBoots extends ItemArmor {
    ...
    public SuperStarBoots() {
        super(ModItems.superStarArmor, armorPreffix, EntityEquipmentSlot.FEET);
        setMaxStackSize(1);
        setRegistryName("super_star_boots");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName(ArmorPlus.MODID + "." + "super_star_boots");     // Used for localization (en_US.lang)
