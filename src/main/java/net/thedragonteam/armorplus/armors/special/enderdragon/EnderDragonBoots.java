...
public class EnderDragonBoots extends BaseArmor {
    ...
    public EnderDragonBoots() {
        super(ModItems.enderDragonArmor, 0, EntityEquipmentSlot.FEET, "ender_dragon_boots", ModItems.enderDragonScale, ModItems.enderDragonScale, TextFormatting.DARK_PURPLE);
    }
