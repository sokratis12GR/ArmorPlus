 ...
 * - TheDragonTeam
 */
public class ChickenLeggings extends BaseArmor {

    public ChickenLeggings() {
        super(ModItems.chickenArmor, 0, EntityEquipmentSlot.LEGS, "chicken_leggings", Items.FEATHER, Items.FEATHER, TextFormatting.AQUA);
    }
