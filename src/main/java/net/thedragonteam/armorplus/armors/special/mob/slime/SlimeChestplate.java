...
public class SlimeChestplate extends ItemArmor {
    ...
    public SlimeChestplate() {
        super(ModItems.SLIME_ARMOR_MATERIAL, armorPreffix, EntityEquipmentSlot.CHEST);
        setMaxStackSize(1);
        setRegistryName("slime_chestplate");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName("SlimeChestplate");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:SlimeChestplate", "inventory"));
    }
