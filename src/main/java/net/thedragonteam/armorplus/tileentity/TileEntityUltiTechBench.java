...
public class TileEntityUltiTechBench extends TileEntity implements IInventory {
    ...
    public String getName() {
        return this.hasCustomName() ? this.customName : "container.armorplus.ulti_tech_bench";
    }
