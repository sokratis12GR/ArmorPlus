...
public class RedstoneBattleAxe extends ItemSword {
    ...
    public RedstoneBattleAxe(Item.ToolMaterial material) {
        super(material);
        setRegistryName("redstone_battle_axe");        // The unique name (within your mod) that identifies this item
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(ArmorPlus.MODID + ":" + "RedstoneBattleAxe", "inventory"));
    }
