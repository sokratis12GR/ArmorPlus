...
public class ObsidianBow extends ItemBow {
    ...
    public ObsidianBow() {
        ...
        setUnlocalizedName(ArmorPlus.MODID + "." + "obsidian_bow");     // Used for localization (en_US.lang)
        ...
        this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter() {
            ...
            public float apply(ItemStack stack, World worldIn, EntityLivingBase entityIn) {
                if (entityIn == null) {
                    ...
                    return itemstack != null && itemstack.getItem() == ModItems.obsidianBow ? (float) (stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 5.0F : 0.0F;
                }
            }
        });
