...
open class BaseTeslaAxe(material: ToolMaterial, name: String, private var maxCapacity: Int, private var input: Int, private var output: Int) : BaseAxe(material, name) {
