...
public class BaseRFShovel extends BaseShovel implements IEnergyContainerItem {

    protected int capacity;
    protected int maxReceive;
    protected int maxExtract;

    public BaseRFShovel(ToolMaterial material, String name, Set<Block> effectiveOn, int capacity) {
        this(material, name, effectiveOn, capacity, capacity, capacity);
    }

    public BaseRFShovel(ToolMaterial material, String name, Set<Block> effectiveOn, int capacity, int maxTransfer) {
    ...
    public BaseRFShovel setCapacity(int capacity) {
        this.capacity = capacity;
        return this;
    }

    public BaseRFShovel setMaxTransfer(int maxTransfer) {
        setMaxReceive(maxTransfer);
        setMaxExtract(maxTransfer);
        return this;
    }

    public BaseRFShovel setMaxReceive(int maxReceive) {
        this.maxReceive = maxReceive;
        return this;
    }

    public BaseRFShovel setMaxExtract(int maxExtract) {
        this.maxExtract = maxExtract;
        return this;
    }
