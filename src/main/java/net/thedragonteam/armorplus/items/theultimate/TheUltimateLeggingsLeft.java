...
public class TheUltimateLeggingsLeft extends Item {
    ...
    public TheUltimateLeggingsLeft() {
        ...
        setUnlocalizedName("TheUltimateLeggingsLeft");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:TheUltimateLeggingsLeft", "inventory"));
    }
}
