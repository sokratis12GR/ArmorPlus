...
public class TheUltimateHelmetMiddle extends Item {
    ...
    public TheUltimateHelmetMiddle() {
        ...
        setUnlocalizedName("TheUltimateHelmetMiddle");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:TheUltimateHelmetMiddle", "inventory"));
    }
}
