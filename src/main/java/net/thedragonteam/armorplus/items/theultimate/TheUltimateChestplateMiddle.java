...
public class TheUltimateChestplateMiddle extends Item {
    ...
    public TheUltimateChestplateMiddle() {
        ...
        setUnlocalizedName("TheUltimateChestplateMiddle");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:TheUltimateChestplateMiddle", "inventory"));
    }
}
