...
public class TheUltimateLeggingsMiddle extends Item {
    ...
    public TheUltimateLeggingsMiddle() {
        ...
        setUnlocalizedName("TheUltimateLeggingsMiddle");     // Used for localization (en_US.lang)
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation("armorplus:TheUltimateLeggingsMiddle", "inventory"));
    }
}
