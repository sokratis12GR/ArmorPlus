...
public class UltiTechBenchShapedOreRecipeWrapper implements IShapedCraftingRecipeWrapper {

    private final ShapedOreRecipe recipe;
    private final int width;
    private final int height;

    public UltiTechBenchShapedOreRecipeWrapper(ShapedOreRecipe recipe) {
        this.recipe = recipe;
