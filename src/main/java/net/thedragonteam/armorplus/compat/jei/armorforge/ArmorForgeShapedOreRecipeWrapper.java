...
public class ArmorForgeShapedOreRecipeWrapper extends BlankRecipeWrapper implements IShapedCraftingRecipeWrapper {

    private final ShapedOreRecipe recipe;
    private final int width;
    private final int height;

    public ArmorForgeShapedOreRecipeWrapper(ShapedOreRecipe recipe) {
        this.recipe = recipe;
