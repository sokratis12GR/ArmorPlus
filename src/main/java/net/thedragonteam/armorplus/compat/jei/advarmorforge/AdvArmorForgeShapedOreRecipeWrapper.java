...
import net.thedragonteam.armorplus.api.crafting.advarmorforge.ShapedOreRecipe;
...
public class AdvArmorForgeShapedOreRecipeWrapper implements IShapedCraftingRecipeWrapper {

    private final ShapedOreRecipe recipe;
    private final int width;
    private final int height;

    public AdvArmorForgeShapedOreRecipeWrapper(ShapedOreRecipe recipe) {
        this.recipe = recipe;
