...
import net.thedragonteam.armorplus.api.crafting.advarmorforge.ShapelessOreRecipe;

import java.util.List;

public class AdvArmorForgeShapelessOreRecipeHandler implements IRecipeHandler<ShapelessOreRecipe> {
    private final IGuiHelper guiHelper;

    public AdvArmorForgeShapelessOreRecipeHandler(IGuiHelper guiHelper) {
    ...
    public IRecipeWrapper getRecipeWrapper(ShapelessOreRecipe recipe) {
        return new AdvArmorForgeShapelessOreRecipeWrapper(guiHelper, recipe);
    }
