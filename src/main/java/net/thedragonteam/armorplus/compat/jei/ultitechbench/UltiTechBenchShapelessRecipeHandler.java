 ...
 * - TheDragonTeam
 */
public class UltiTechBenchShapelessRecipeHandler implements IRecipeHandler<ShapelessRecipes> {

    @Nonnull
    private final IGuiHelper guiHelper;

    public UltiTechBenchShapelessRecipeHandler(@Nonnull IGuiHelper guiHelper) {
    ...
    public IRecipeWrapper getRecipeWrapper(@Nonnull ShapelessRecipes recipe) {
        return new UltiTechBenchShapelessRecipeWrapper(guiHelper, recipe);
    }
