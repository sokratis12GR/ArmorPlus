...
class WBShapelessOreRecipeHandler(private val jeiHelpers: IJeiHelpers) : IRecipeHandler<ShapelessOreRecipe> {
    ...
    override fun getRecipeWrapper(recipe: ShapelessOreRecipe): IRecipeWrapper {
        return WBShapelessOreRecipeWrapper(jeiHelpers, recipe)
    }
