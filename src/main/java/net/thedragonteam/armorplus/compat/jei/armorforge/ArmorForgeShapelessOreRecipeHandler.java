...
public class ArmorForgeShapelessOreRecipeHandler implements IRecipeHandler<ShapelessOreRecipe> {
    private final IGuiHelper guiHelper;

    public ArmorForgeShapelessOreRecipeHandler(IGuiHelper guiHelper) {
    ...
    public IRecipeWrapper getRecipeWrapper(ShapelessOreRecipe recipe) {
        return new ArmorForgeShapelessOreRecipeWrapper(guiHelper, recipe);
    }
