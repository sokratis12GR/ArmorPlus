 ...
 * - TheDragonTeam
 */
public class HTBShapedRecipeWrapper extends BlankRecipeWrapper implements IShapedCraftingRecipeWrapper {

    @Nonnull
    private final ShapedRecipes recipe;

    HTBShapedRecipeWrapper(@Nonnull ShapedRecipes recipe) {
        this.recipe = recipe;
