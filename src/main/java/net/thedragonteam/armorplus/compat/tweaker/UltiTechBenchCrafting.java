...
import net.thedragonteam.armorplus.api.crafting.ultitechbench.IRecipe;
...
@ZenClass("mods.armorplus.UltiTechBenchCrafting")
public class UltiTechBenchCrafting {
    ...
    private static class Add implements IUndoableAction {
        ...
        public String describe() {
            return "Adding Ulti-Tech Bench Crafting Recipe for " + recipe.getRecipeOutput().getDisplayName();
        }

        @Override
        public String describeUndo() {
            return "Un-adding Ulti-Tech Bench Crafting Recipe for " + recipe.getRecipeOutput().getDisplayName();
        }
    ...
    private static class Remove implements IUndoableAction {
        ...
        @Override
        public String describe() {
            return "Removing Ulti-Tech Bench Crafting Recipe for " + remove.getDisplayName();
        }

        @Override
        public String describeUndo() {
            return "Un-removing Ulti-Tech Bench Crafting Recipe for " + remove.getDisplayName();
        }
