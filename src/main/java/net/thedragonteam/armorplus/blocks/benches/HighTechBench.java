 ...
 * - TheDragonTeam
 */
public class HighTechBench extends BaseBlock implements ITileEntityProvider {

    public HighTechBench() {
        super(Material.IRON, "high_tech_bench", 1000.0F, 10.0F, "pickaxe", 2);
