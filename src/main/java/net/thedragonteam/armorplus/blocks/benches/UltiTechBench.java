 ...
 * - TheDragonTeam
 */
public class UltiTechBench extends BaseBlock implements ITileEntityProvider {

    public UltiTechBench() {
        super(Material.ROCK, "ulti_tech_bench", 1000.0F, 10.0F, "pickaxe", 2);
