 ...
 * - TheDragonTeam
 */
public class ChampionBenchRecipe {
    protected ItemStack output = null;
    protected ArrayList<Object> input = new ArrayList<>();

    public ChampionBenchRecipe(Block result, Object... recipe) {
        this(new ItemStack(result), recipe);
    }

    public ChampionBenchRecipe(Item result, Object... recipe) {
        this(new ItemStack(result), recipe);
    }

    public ChampionBenchRecipe(ItemStack result, Object... recipe) {
        output = result.copy();
