...
public class AdvancedArmorForgeRecipe {
    ...
    public AdvancedArmorForgeRecipe(Block result, Object... recipe) {
        this(new ItemStack(result), recipe);
    }

    public AdvancedArmorForgeRecipe(Item result, Object... recipe) {
        this(new ItemStack(result), recipe);
    }

    public AdvancedArmorForgeRecipe(ItemStack result, Object... recipe) {
        output = result.copy();
        for (Object in : recipe) {
            if (in instanceof ItemStack) {
                ...
                String ret = "Invalid Advanced Armor Forge recipe: ";
