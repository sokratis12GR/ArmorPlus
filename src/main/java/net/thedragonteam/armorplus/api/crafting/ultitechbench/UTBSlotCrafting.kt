...
class UTBSlotCrafting(
    ...
    override fun onCrafting(stack: ItemStack?) {
       ...
       //   stack!!.item === theUltimateHelmet || stack!!.item === theUltimateChestplate || stack!!.item === theUltimateLeggings || stack!!.item === theUltimateBoots -> this.player.addStat(ModAchievements.craftTheUltimateArmor, 1)
        }
    }
