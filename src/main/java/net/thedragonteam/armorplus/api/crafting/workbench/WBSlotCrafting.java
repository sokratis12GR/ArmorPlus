...
public class WBSlotCrafting extends Slot {
    ...
    public WBSlotCrafting(EntityPlayer player, InventoryCraftingImproved craftingInventory, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition) {
