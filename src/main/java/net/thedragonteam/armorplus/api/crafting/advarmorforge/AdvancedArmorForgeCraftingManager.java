...
import net.thedragonteam.armorplus.api.crafting.advarmorforge.recipes.ModEnderDragonRecipes;
import net.thedragonteam.armorplus.api.crafting.advarmorforge.recipes.ModGuardianRecipes;
import net.thedragonteam.armorplus.api.crafting.advarmorforge.recipes.ModSuperStarRecipes;
import net.thedragonteam.armorplus.api.crafting.advarmorforge.recipes.ModTheUltimateRecipes;
...
public class AdvancedArmorForgeCraftingManager {
    ...
    private AdvancedArmorForgeCraftingManager() {
        ...
        (new ModTheUltimateRecipes()).addRecipes(this);
