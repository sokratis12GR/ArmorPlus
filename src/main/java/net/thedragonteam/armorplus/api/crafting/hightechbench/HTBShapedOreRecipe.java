...
public class HTBShapedOreRecipe implements IRecipe {
    ...
    public HTBShapedOreRecipe(Block result, Object... recipe) {
        this(new ItemStack(result), recipe);
    }

    public HTBShapedOreRecipe(Item result, Object... recipe) {
        this(new ItemStack(result), recipe);
    }

    public HTBShapedOreRecipe(ItemStack result, Object... recipe) {
        output = result.copy();
    ...
    public HTBShapedOreRecipe setMirrored(boolean mirror) {
        mirrored = mirror;
        return this;
    }
