...
public class ModItemsRecipes {
    ...
    public void addRecipes(WorkbenchCraftingManager manager) {
        ...
        manager.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.itemRFRod, 1),
                ...
                'T', "dustRedstone",
                'S', "stickWood"));
        manager.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.itemRFAxe, 1),
                "TT ",
                "TS ",
                " S ",
                'T', "ingotSteel",
        ...
        manager.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.itemRFAxe, 1),
                ...
                'T', "ingotSteel",
                'S', "rodRF"));
        manager.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.itemRFShovel, 1),
                " T ",
                " S ",
                " S ",
                'T', "ingotSteel",
                'S', "rodRF"));
        manager.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.itemRFHoe, 1),
                "TT ",
                " S ",
                " S ",
                'T', "ingotSteel",
        ...
        manager.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.itemRFHoe, 1),
                ...
                'T', "ingotSteel",
                'S', "rodRF"));
        manager.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.itemRFSword, 1),
                " T ",
                " T ",
                " S ",
                'T', "ingotSteel",
                'S', "rodRF"));
        manager.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.itemRFPickaxe, 1),
                "TTT",
                " S ",
                " S ",
                'T', "ingotSteel",
