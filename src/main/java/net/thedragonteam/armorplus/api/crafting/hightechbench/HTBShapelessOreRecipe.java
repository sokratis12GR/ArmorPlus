...
public class HTBShapelessOreRecipe implements IRecipe {
    protected ItemStack output = ItemStack.EMPTY;
    protected NonNullList<Object> input = NonNullList.create();

    public HTBShapelessOreRecipe(Block result, Object... recipe) {
        this(new ItemStack(result), recipe);
    }

    public HTBShapelessOreRecipe(Item result, Object... recipe) {
        this(new ItemStack(result), recipe);
    }

    public HTBShapelessOreRecipe(@Nonnull ItemStack result, Object... recipe) {
        output = result.copy();
