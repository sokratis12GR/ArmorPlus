...
public class CBShapedOreRecipe implements IRecipe {
    ...
    public CBShapedOreRecipe(Block result, Object... recipe) {
        this(new ItemStack(result), recipe);
    }

    public CBShapedOreRecipe(Item result, Object... recipe) {
        this(new ItemStack(result), recipe);
    }

    public CBShapedOreRecipe(ItemStack result, Object... recipe) {
        output = result.copy();
    ...
    CBShapedOreRecipe(CBShapedRecipe recipe, Map<ItemStack, String> replacements) {
    ...
    public CBShapedOreRecipe setMirrored(boolean mirror) {
        mirrored = mirror;
        return this;
    }
