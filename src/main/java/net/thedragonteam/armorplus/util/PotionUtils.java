...
public class PotionUtils {
    ...
    public static void removePotion(EntityLivingBase entity, String potion) {
        removePotion(entity, (potion != null) ? getPotion(potion) : ModPotions.INSTANCE.getEMPTY());
    }

    public static void removePotion(EntityLivingBase entity, Potion potion) {
        entity.removePotionEffect((potion != null) ? potion : ModPotions.INSTANCE.getEMPTY());
    }

    public static String localizePotion(String resourceLocation) {
        return (getPotion(resourceLocation) != null) ? TextUtils.formattedText(getPotion(resourceLocation).getName() + ".name") : "";
    }

    public static Potion getPotion(String resourceLocation) {
        return (getPotionFromResourceLocation(resourceLocation) != null) ? getPotionFromResourceLocation(resourceLocation) : ModPotions.INSTANCE.getEMPTY();
    }
