 ...
 * - TheDragonTeam
 */
public class GuiARPWorkbench extends GuiContainer {
    ...
    public GuiARPWorkbench(InventoryPlayer playerInv, World worldIn, TileEntityWorkbench tileEntity) {
        this(playerInv, worldIn, BlockPos.ORIGIN, tileEntity);
    }

    public GuiARPWorkbench(InventoryPlayer playerInv, World worldIn, BlockPos blockPosition, TileEntityWorkbench tileEntity) {
        super(new ContainerWorkbench(playerInv, worldIn, blockPosition, tileEntity));
        this.xSize = 176;
        this.ySize = 165;
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.fontRendererObj.drawString(I18n.format("container.armorplus.arp_workbench", new Object[0]), 28, 6, 4210752);
