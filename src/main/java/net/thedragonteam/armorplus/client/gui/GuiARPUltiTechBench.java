 ...
 * - TheDragonTeam
 */
public class GuiARPUltiTechBench extends GuiContainer {
    ...
    public GuiARPUltiTechBench(InventoryPlayer playerInv, World worldIn, TileEntityUltiTechBench tileEntity) {
        this(playerInv, worldIn, BlockPos.ORIGIN, tileEntity);
    }

    public GuiARPUltiTechBench(InventoryPlayer playerInv, World worldIn, BlockPos blockPosition, TileEntityUltiTechBench tileEntity) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.fontRendererObj.drawString(I18n.format("container.armorplus.arp_ulti_tech_bench", new Object[0]), 28, 6, 4210752);
