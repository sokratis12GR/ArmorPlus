...
public class GuiWorkbench extends GuiContainer {
    ...
    public GuiWorkbench(InventoryPlayer playerInv, World worldIn, TileEntityWorkbench tileEntity) {
        this(playerInv, worldIn, BlockPos.ORIGIN, tileEntity);
    }

    public GuiWorkbench(InventoryPlayer playerInv, World worldIn, BlockPos blockPosition, TileEntityWorkbench tileEntity) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.fontRendererObj.drawString(I18n.format("container.armorplus.workbench", new Object[0]), 28, 6, 4210752);
