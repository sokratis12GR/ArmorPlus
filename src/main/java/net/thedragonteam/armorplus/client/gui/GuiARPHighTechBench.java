 ...
 * - TheDragonTeam
 */
public class GuiARPHighTechBench extends GuiContainer {
    ...
    public GuiARPHighTechBench(InventoryPlayer playerInv, World worldIn, TileEntityHighTechBench tileEntity) {
        this(playerInv, worldIn, BlockPos.ORIGIN, tileEntity);
    }

    public GuiARPHighTechBench(InventoryPlayer playerInv, World worldIn, BlockPos blockPosition, TileEntityHighTechBench tileEntity) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.fontRendererObj.drawString(I18n.format("container.armorplus.arp_high_tech_bench", new Object[0]), 28, 6, 4210752);
