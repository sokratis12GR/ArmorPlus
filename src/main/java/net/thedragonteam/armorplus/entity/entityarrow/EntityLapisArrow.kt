...
class EntityLapisArrow : EntityArrow {
    ...
    public override fun getArrowStack(): ItemStack {
        return ItemStack(ModItems.itemLapisArrow)
    }

    public override fun arrowHit(living: EntityLivingBase?) {
        super.arrowHit(living)

        if (living !== shootingEntity) addPotion(living as EntityLivingBase, MobEffects.NAUSEA, 180, 0, BAD)
    }
