...
public class ModdedArrows {
    ...
    public static ArrowProperties coalArrow = new ArrowProperties(3.0, CLOUD, itemCoalArrow) {
        @Override
    ...
    public static ArrowProperties lapisArrow = new ArrowProperties(3.5, WATER_DROP, itemLapisArrow) {
        @Override
        public void arrowHit(EntityLivingBase living, Entity shootingEntity) {
            if (living != shootingEntity) addPotion(living, MobEffects.NAUSEA, 180, 0, BAD);
        }
    };
    public static ArrowProperties redstoneArrow = new ArrowProperties(3.5, REDSTONE, itemRedstoneArrow) {
        @Override
        public void arrowHit(EntityLivingBase living, Entity shootingEntity) {
            if (living != shootingEntity) addPotion(living, MobEffects.SLOWNESS, 180, 0, BAD);
        }
    };
    public static ArrowProperties lavaArrow = new ArrowProperties(5.5, FLAME, itemLavaArrow) {
        @Override
        public void arrowHit(EntityLivingBase living, Entity shootingEntity) {
            if (living != shootingEntity) living.setFire(6);
        }
    };
    public static ArrowProperties enderDragonArrow = new ArrowProperties(10.5, DRAGON_BREATH, itemEnderDragonArrow) {
        @Override
        public void arrowHit(EntityLivingBase living, Entity shootingEntity) {
