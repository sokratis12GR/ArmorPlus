...
public class ARPAchievements
{
    ...
    public static Achievement craftLavaArmor;//2,-2
    ...
    public static void init()
    {
        ...
        craftObsidianArmor = new AchievementARP("craftObsidianArmor", 2, -2, ObsidianArmor.chestplate, craftEmeraldArmor).setNormalCrafting();
