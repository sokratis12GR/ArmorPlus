...
public class ARPAchievements {
    ...
    public static void init() {
        ...
        /** Right */
        CRAFT_OBSIDIAN_ARMOR = new AchievementARP("craftObsidianArmor", 2, 0, ObsidianArmor.chestplate, CRAFT_COAL_ARMOR).setNormalCrafting();
        CRAFT_LAVA_ARMOR = new AchievementARP("craftLavaArmor", 4, 0, LavaArmor.chestplate, CRAFT_OBSIDIAN_ARMOR).setNormalCrafting();
        ...
        CRAFT_ARDITE_ARMOR = new AchievementARP("craftArditeArmor", -4, 0, ArditeArmor.chestplate, CRAFT_COBALT_ARMOR).setNormalCrafting();
        CRAFT_MANYULLYN_ARMOR = new AchievementARP("craftManyullynArmor", -6, 0, ManyullynArmor.chestplate, CRAFT_ARDITE_ARMOR).setNormalCrafting();
        CRAFT_PIG_IRON_ARMOR = new AchievementARP("craftPigIronArmor", -2, -2, PigIronArmor.chestplate, CRAFT_COBALT_ARMOR).setNormalCrafting();
        CRAFT_KNIGHT_SLIME_ARMOR = new AchievementARP("craftKnightSlimeArmor", -2, 2, KnightSlimeArmor.chestplate, CRAFT_COBALT_ARMOR).setNormalCrafting();
