...
public class ModRecipes {
    ...
    public static void init() {
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.ARMOR_FORGE), "LCL", "OWO", "OXO", 'W', "Workbench", 'O', new ItemStack(Blocks.OBSIDIAN), 'L', new ItemStack(Blocks.LAPIS_BLOCK), 'C', new ItemStack(ModItems.LAVA_CRYSTAL)));
